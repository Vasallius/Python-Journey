...
doc = docx.Document('blank.docx')
# Add the paragraph and set corresponding styles
for index, guest in enumerate(guest_list):
    doc.add_paragraph('It would be a pleasure to have the company of').style = 'inv-heading'
    doc.add_paragraph(guest).style = 'name'
    doc.add_paragraph('At 11010 Memory Lane on the Evening of').style = 'inv-heading'
